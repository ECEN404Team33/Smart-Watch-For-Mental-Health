...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HealthDashboardWidget() : SignInWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: HeartRateVariabilityWidget.routeName,
          path: HeartRateVariabilityWidget.routePath,
          builder: (context, params) => HeartRateVariabilityWidget(),
        ),
        FFRoute(
          name: MovementWidget.routeName,
          path: MovementWidget.routePath,
          builder: (context, params) => MovementWidget(),
        ),
        FFRoute(
          name: MusicWidget.routeName,
          path: MusicWidget.routePath,
          builder: (context, params) => MusicWidget(),
        ),
        FFRoute(
          name: MeditationWidget.routeName,
          path: MeditationWidget.routePath,
        ...
        FFRoute(
          name: AgeWidget.routeName,
          path: AgeWidget.routePath,
          builder: (context, params) => AgeWidget(),
        ),
        FFRoute(
          name: BreathingWidget.routeName,
          path: BreathingWidget.routePath,
          builder: (context, params) => BreathingWidget(),
        ),
        FFRoute(
